...
This mashup wouldn't have been possible without the underlying pieces, namely Namecoin and MinimaLT.


Most of the Namecoin research is based on Greg Slepak's paper\cite{okTurtles} \emph{OkTurtles + DNSNMC}. 
